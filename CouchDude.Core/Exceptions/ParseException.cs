...
namespace CouchDude.Core
{
	...
	[Serializable]
	public partial class ParseException: CouchDudeException
	{
		/// <summary>Initializes a new instance of the 
		/// <see cref="ParseException" /> class.</summary>
		...
		public ParseException(string messageTemplate, params object[] messageParams)
		...
		public ParseException(Exception innerException, string message)
