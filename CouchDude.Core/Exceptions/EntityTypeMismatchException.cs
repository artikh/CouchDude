...
namespace CouchDude.Core
{
	...
	[Serializable]
	public partial class EntityTypeMismatchException: CouchDudeException
	{
		...
		public EntityTypeMismatchException(SerializationInfo info, StreamingContext context)
			: base(info, context) { }

		/// <summary>Initializes a new instance of the <see cref="EntityTypeMismatchException" /> class.</summary>
		/// <param name="message">The message.</param>
		/// <param name="messageParams">The message params.</param>
		public EntityTypeMismatchException(string message, params object[] messageParams)
