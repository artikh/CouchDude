...
namespace CouchDude.Core
{
	...
	[Serializable]
	public partial class CouchCommunicationException: CouchDudeException
	{
		/// <summary>Initializes a new instance of the 
		/// <see cref="CouchCommunicationException" /> class.</summary>
		...
		public CouchCommunicationException(SerializationInfo info, StreamingContext context)
			: base(info, context) { }

		/// <summary>Initializes a new instance of the <see cref="CouchCommunicationException" /> class.</summary>
		/// <param name="message">The message.</param>
		public CouchCommunicationException(string message): base(message) { }

		/// <summary>Initializes a new instance of the <see cref="CouchCommunicationException" /> class.</summary>
		/// <param name="messageTemplate">The message template.</param>
		/// <param name="messageParams">The message params.</param>
		[JetBrains.Annotations.StringFormatMethod("messageTemplate")]
		public CouchCommunicationException(string messageTemplate, params object[] messageParams)
		...
		/// <param name="messageParams">The message params.</param>
		[JetBrains.Annotations.StringFormatMethod("messageTemplate")]
		public CouchCommunicationException(
		...
		/// <param name="innerException">The inner exception.</param>
		[JetBrains.Annotations.StringFormatMethod("messageTemplate")]
		public CouchCommunicationException(Exception innerException)
		...
		public CouchCommunicationException(Exception innerException, string message)
