...
namespace CouchDude
{
	/// <summary>Represents simple JSON object. Data could be accessed as dynamic.</summary>
	public interface IJsonObject : IDynamicMetaObjectProvider
	{
		/// <summary>Produces <see cref="TextReader"/> over content of the JSON object.</summary>
