...
namespace CouchDude
{
	...
	public class WrappingDocumentAttachment: DocumentAttachment
	{
		...
		protected internal WrappingDocumentAttachment(string id, Document parentDocument): base(id)
		{
		...
		private JsonObject AttachmentDescriptor
		{
			get
			{
				return parentDocument
					.RawJsonObject
					.GetOrCreateObjectProperty(DocumentAttachmentBag.AttachmentsPropertyName)
