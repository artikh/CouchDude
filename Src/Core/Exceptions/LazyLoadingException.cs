...
namespace CouchDude
{
	...
	[Serializable]
	public partial class LazyLoadingException: CouchDudeException
	{
		/// <summary>Initializes a new instance of the 
		/// <see cref="LazyLoadingException" /> class.</summary>
		...
		public LazyLoadingException(SerializationInfo info, StreamingContext context)
			: base(info, context) { }

		/// <summary>Initializes a new instance of the <see cref="LazyLoadingException" /> class.</summary>
		/// <param name="message">The message.</param>
		public LazyLoadingException(string message): base(message) { }

		/// <summary>Initializes a new instance of the <see cref="LazyLoadingException" /> class.</summary>
		/// <param name="messageTemplate">The message template.</param>
		/// <param name="messageParams">The message params.</param>
		[JetBrains.Annotations.StringFormatMethod("messageTemplate")]
		public LazyLoadingException(string messageTemplate, params object[] messageParams)
		...
		/// <param name="innerException">The inner exception.</param>
		[JetBrains.Annotations.StringFormatMethod("messageTemplate")]
		public LazyLoadingException(Exception innerException)
		...
		public LazyLoadingException(Exception innerException, string message)
